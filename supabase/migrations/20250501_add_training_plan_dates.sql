-- Garante que training_plans possui colunas de datas utilizadas pelo dashboard e clientes.
-- Também tenta reaproveitar dados existentes caso outras colunas tenham sido usadas anteriormente.
...
BEGIN
  ...
  -- Sempre que possível, reaproveita valores de colunas antigas.
  IF EXISTS (
    SELECT 1 FROM information_schema.columns
