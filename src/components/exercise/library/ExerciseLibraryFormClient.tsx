...
export default function ExerciseLibraryFormClient({ mode, initial, onSuccess }: Props) {
  ...
  const muscleTags = React.useMemo(() => parseExerciseTags(values.muscle_group), [values.muscle_group]);
  const equipmentTags = React.useMemo(() => parseExerciseTags(values.equipment), [values.equipment]);
              ...
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    helperText={
                      errors.muscle_group ?? 'Separa com vírgulas para adicionares vários grupos.'
                    }
                    fullWidth
                  />
                </Grid>
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    helperText={
                      errors.equipment ?? 'Separa com vírgulas para listar vários equipamentos (opcional).'
                    }
                    fullWidth
                  />
                </Grid>
