  ...
  const groups: NavGroup[] = [
    {
      ...
      items: [
        ...
        { href: '/dashboard/reports', label: 'Relatórios', icon: <Ic.Reports /> },
        { href: '/dashboard/settings', label: 'Definições', icon: <Ic.Settings /> },
      ],
    },
    {
      title: 'Admin',
      items: [
        { href: '/dashboard/admin/approvals', label: 'Aprovações', icon: <Ic.Approvals /> },
        { href: '/dashboard/admin/users', label: 'Utilizadores', icon: <Ic.Users /> },
        { href: '/dashboard/admin/system-health', label: 'Saúde do sistema', icon: <Ic.Health /> },
      ],
    },
    {
      title: 'Faturação',
