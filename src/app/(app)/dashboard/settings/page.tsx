...
export default async function SettingsPage() {
  ...
  if (role === "ADMIN") {
    model.adminPreferences = normalizeAdminSettings(storedRoleSettings);
  }
  if (role === "PT") {
    model.trainerPreferences = normalizeTrainerSettings(storedRoleSettings);
  }
  if (role === "CLIENT") {
    model.clientPreferences = normalizeClientSettings(storedRoleSettings);
  }
