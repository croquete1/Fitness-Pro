...
- [x] Recriar o login/registo com branding HMS, fundo gradiente e copy unificada (sem “Bem-vindo de volta”). Fontes: `src/app/login/LoginClient.tsx`, `src/app/register/RegisterClient.tsx`.
