...
- [x] Modernizar o painel inicial do admin com greeting contextual, métricas dinâmicas e gestão de frases motivadoras integrada. Fontes: `src/app/(app)/dashboard/admin/page.tsx`, `src/components/admin/MotivationAdminCard.tsx`.
